...
namespace Rechner01
{
    ...
    {//globale variablen
      ...
      static   CancellationTokenSource sourcecancel = new CancellationTokenSource();
        ...
        //hier steht auch nix .. is nur für die übersicht
        ...
        private void ergebnis() //ErgebnisMethode
        {
            switch (hmmm.Operant)
            {
                ...
                case "mod":
                    ...
                    break;
                case "x²":
                    Operanten.Quadrat(hmmm);
                        textbox1.Clear();
                    textbox1.Text = hmmm.Zahl1.ToString();
                    break;
                case "√":
                    Operanten.Wurzel(hmmm);
                    textbox1.Clear();
                    textbox1.Text = hmmm.Zahl1.ToString();

                    break;
                case "sin":
                    Operanten.Sinus(hmmm);
                    textbox1.Clear();
                    textbox1.Text = hmmm.Zahl1.ToString();
                    break;
                case "cos":
                    Operanten.Cosinus(hmmm);
                    textbox1.Clear();
                    textbox1.Text = hmmm.Zahl1.ToString();
                    break;
                case "tan":
                    Operanten.Tangenz(hmmm);
                    textbox1.Clear();
                    textbox1.Text = hmmm.Zahl1.ToString();
                    break;
                case "xⁿ":
                    Operanten.Xquadrat(hmmm);//////todo
                    textbox1.Clear();
                    textbox1.Text = hmmm.Zahl1.ToString();
                    break;
                case "∛ⁿ":
                    Operanten.DritteWurzel(hmmm);
                    textbox1.Clear();
                    textbox1.Text = hmmm.Zahl1.ToString();
                    break;
                case "π":
        ...
        */
        ...
        private void Back_Click(object sender, RoutedEventArgs e)/////event für farbe ändern
        {
            Random r = new Random();
